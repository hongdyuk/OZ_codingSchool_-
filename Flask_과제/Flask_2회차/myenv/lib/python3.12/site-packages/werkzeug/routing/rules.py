...
class RuleTemplate:
    ...
    Here a small example for such a rule templates::
    ...
    When a rule templates is called the keyword arguments are used to
...
class RuleTemplateFactory(RuleFactory):
    """A factory that fills in templates variables into rules.  Used by
