...
# these variables are exported to the templates runtime
exported = [
    "LoopContext",
    "TemplateReference",
    "Macro",
...
class Context:
    """The templates context holds the variables of a templates.  It stores the
    values passed to the templates and also the names the templates exports.
    Creating instances is neither supported nor useful as it's created
    automatically at various stages of the templates evaluation and should not
    be created by hand.

    The context is immutable.  Modifications on :attr:`parent` **must not**
    happen and modifications on :attr:`vars` are allowed from generated
    templates code only.  Template filters and global functions marked as
    :func:`pass_context` get the active context passed as first argument
    and are allowed to access the context read-only.

    The templates context supports read only dict operations (`get`,
    ...
    def __init__(
        ...
        # create the initial mapping of blocks.  Whenever templates inheritance
...
class BlockReference:
    """One block on a templates reference."""
