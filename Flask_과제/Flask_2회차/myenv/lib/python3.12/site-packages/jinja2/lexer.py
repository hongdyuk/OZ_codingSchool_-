...
templates code and python code in expressions.
"""
...
def _describe_token_type(token_type: str) -> str:
    ...
    return {
        ...
        TOKEN_DATA: "templates data / text",
        TOKEN_EOF: "end of templates",
        ...
        if not self.current.test(expr):
            ...
            if self.current.type is TOKEN_EOF:
                raise TemplateSyntaxError(
                    f"unexpected end of templates, expected {expr!r}.",
                    self.current.lineno,
                    self.name,
                    self.filename,
                )
...
class Lexer:
    ...
    def tokeniter(
        ...
        generator. Use this method if you just want to tokenize a templates.
