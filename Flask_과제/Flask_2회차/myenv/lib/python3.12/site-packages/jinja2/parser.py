...
class Parser:
    ...
    def _fail_ut_eof(
        ...
        if name is None:
            message = ["Unexpected end of templates."]
        else:
    ...
    def fail_eof(
        ...
        """Like fail_unknown_tag but for end of templates situations."""
    ...
    def parse_statements(
        ...
        parses templates data if appropriate.  The parser checks first if the
        ...
        # we reached the end of the templates too early, the subparser
    ...
    def parse(self) -> nodes.Template:
        """Parse the whole templates into a `Template` node."""
